...
describe Theme do
  ...
  it 'should create a unique code based on the name' do
    ...
    FactoryGirl.create(:theme, :name => 'Use first three').code.should eql('UFT')

    # take 1st 2 letters from 1st word, 2nd letter from 2nd word
    FactoryGirl.create(:theme, :name => '12 Examples').code.should eql('12E')

    # take 1st 3 letters from 1st word
    FactoryGirl.create(:theme, :name => 'Visitors').code.should eql('VIS')

    # ignore punctuation and treat as words
    FactoryGirl.create(:theme, :name => 'Here-is////A').code.should eql('HIA')

    # take 1st letter from 1st word, 2nd two letters from 2nd word
    theme = FactoryGirl.create(:theme, :name => 'T Example')
    ...
    FactoryGirl.create(:theme, :name => 'T Example2', :backlog => backlog).code.should eql('TE1')

    # fill up slots up to 24, next available should be T25
    (2..9).each do |index|
      FactoryGirl.create(:theme, :name => "T Example #{index}", :backlog => backlog, :code => "TE#{index}")
    end
    (10..24).each do |index|
      FactoryGirl.create(:theme, :name => "T Example #{index}", :backlog => backlog, :code => "T#{index}")
    end
    FactoryGirl.create(:theme, :name => 'T Example 25', :backlog => backlog).code.should eql('T25')
  end
  ...
  it 'should ensure days and costs are accurate based on the stories' do
    ...
    story = FactoryGirl.create(:story, :theme => theme, :score_50 => 5, :score_90 => 8)
  ...
  it 'should be able to renumber stories' do
    theme = FactoryGirl.create(:theme)
    story1 = FactoryGirl.create(:story, :theme => theme)
    story2 = FactoryGirl.create(:story, :theme => theme)
    story3 = FactoryGirl.create(:story, :theme => theme)
    story3.move_to_top
  ...
  it 'should not allow stories to be renumbered when one or more stories are Accepted' do
    status_accepted = FactoryGirl.create(:sprint_story_status_accepted)
    theme = FactoryGirl.create(:theme)
    story1 = FactoryGirl.create(:story, :theme => theme)
    story2 = FactoryGirl.create(:story, :theme => theme)

    sprint = FactoryGirl.create(:sprint, :backlog => theme.backlog)
  ...
  it 'should create a new theme with edge case theme name "Safe hands user tests"' do
    theme = FactoryGirl.create(:theme, :name => 'Safe hands users tests')
  ...
  describe '#add_existing_story' do
    it 'should allow stories from an existing theme to be moved to this theme' do
      story_theme1 = FactoryGirl.create(:story)
      theme1 = story_theme1.theme
      theme2 = FactoryGirl.create(:theme, :backlog => theme1.backlog)
      story_theme2 = FactoryGirl.create(:story, :theme => theme2)
    ...
    it 'should allow stories from an existing theme to be moved to this theme and keep the unique ID if available' do
      ...
      theme1 = story_theme1.theme
      theme2 = FactoryGirl.create(:theme, :backlog => theme1.backlog)
      story1_theme2 = FactoryGirl.create(:story, :theme => theme2)
      story2_theme2 = FactoryGirl.create(:story, :theme => theme2, :unique_id => 4)
    ...
    it 'should not allow stories from another backlog to be moved to this theme' do
      story_theme1 = FactoryGirl.create(:story)
      story_theme2 = FactoryGirl.create(:story)
  ...
  describe '#move_to_backlog' do
    it 'should not allow a theme to be moved if any of the stories are assigned to a sprint' do
      backlog_target = FactoryGirl.create(:backlog)
      story = FactoryGirl.create(:story)
      backlog = story.theme.backlog
      sprint = FactoryGirl.create(:sprint, :backlog => backlog)
      sprint_story = FactoryGirl.create(:sprint_story, :sprint => sprint, :story => story)
    ...
    it 'should rename the theme code if one already exists' do
      ...
      theme_conflict = FactoryGirl.create(:theme, :backlog => backlog_target, :code => source_theme_code)
    ...
    it 'should rename the theme name if one already exists' do
      ...
      theme_conflict = FactoryGirl.create(:theme, :backlog => backlog_target, :name => source_theme_name)
