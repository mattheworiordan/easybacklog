  ...
  private
    def add_story(pdf, document_options, page_size, fold_side, story)
      ...
      standard_box_fields(story, pdf, offset, card_width*0.9, card_height*0.9) do
        pdf.text_box "#{I18n.t 'backlog.backlog'}: #{story.theme.backlog.name}",
        ...
        pdf.formatted_text_box [
            ...
            {:text => "\n#{I18n.t 'backlog.i_want_to'} ", :color => '666666'}, {:text => "#{story.i_want_to}", :styles => [:bold]},
            {:text => "\n#{I18n.t 'backlog.so_i_can'} ", :color => '666666'}, {:text => "#{story.so_i_can}", :styles => [:bold]}
          ],
      ...
      standard_box_fields(story, pdf, offset, card_width*0.9, card_height*0.9) do
        ...
        pdf.formatted_text_box [
            {:text => "#{I18n.t 'backlog.acceptance_criteria'}\n", :styles => [:bold], :size => 16},
            {:text => "\n", :size => 6},
