...
}_.extend(rules,{"user[name]":"required","user[email]":{required:true,email:true,remote:"/users/email_available"},"user[password]":{required:true,minlength:6},"user[password_confirmation]":{equalTo:"#user_password"}});
