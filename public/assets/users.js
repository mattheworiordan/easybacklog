...
var params={url:document.location.pathname+"/"+id,type:"PUT",contentType:"application/json",data:JSON.stringify(payLoad),dataType:"json",processData:false,success:function(data){if(window.console){console.log("Updated user successfully")
}},error:function(jqXHR,textStatus,errorThrown){if(window.console){console.log(textStatus)
