...
/**
  ...
  * @param Integer options[maxLength] maximum number of characters for this field
            ...
            text: {
                element : function(settings, original) {
                    ...
                    if (settings.autoComplete) {
                      input.autocomplete({
                        source: ($.isArray(settings.autoComplete) ? settings.autoComplete : settings.autoComplete()),
                        minLength: 0,
                        delay: 0
                      });
                    }
            ...
            textarea: {
                element : function(settings, original) {
                    ...
                    if (settings.maxLength) {
                      $.each(['keyup','paste','blue'], function(i, eventName) {
                        textarea.bind('keyup', function() {
                          $(this).val($(this).val().slice(0, settings.maxLength));
                        });
                      });
                    }
